...
console.log (faveNum == trueFaveNum);
...
var responseCreator = function(param){
  // CODE HERE
  if (param = "green") {
    console.log (colorResponse = "Green is okay");
  }
  else if (param = "red") {
    console.log (colorResponse = "I heart red");
  }
  else {
    console.log (colorResponse = "What is your favorite color?");
  };
};
